...
public class Errors {
	...
	public static final String TREE_NODE_NOT_FOUND_ERROR = "Label does not correspond to any node";


	public static final String TREE_NODE_ROOT_NOT_FOUND_ERROR = "Cannot found the root";


	public static final String NO_VALID_METHOD_CODE = "No valid method code found";


	public static final String NOT_VALID_MAPPING_LEAF = "No valid mapping: LEAF-RULE";


	public static final String NOT_VALID_MAPPING_PARENT_RULE = "No valid mapping: PARENT-RULE";


	public static final String NOT_VALID_MAPPING_SWITCH_RULE = "No valid mapping: SWITCH-RULE";
